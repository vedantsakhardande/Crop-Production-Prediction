...
# (base) E:\Mini Project Work>"C:/Users/Vedant Sakhardande/Anaconda/python.exe" "e:/Mini Project Work/test.py"
# C:\Users\Vedant Sakhardande\Anaconda\lib\site-packages\h5py\__init__.py:36: FutureWarning: Conversion of the second argument of issubdtype from `float` to `np.floating` is deprecated. In future, it will be treated as `np.float64 == np.dtype(float).type`.
#   from ._conv import register_converters as _register_converters
# Using TensorFlow backend.
# 9
# 1
# Day  18 Month  4 Year  19
# https://www.accuweather.com/en/in/ratnagiri/189289/may-weather/189289?monyr=5/18/19&view=table
# 2019-04-18 13:01:33.798880: I tensorflow/core/platform/cpu_feature_guard.cc:141] Your CPU supports instructions that this TensorFlow binary was not compiled to use: AVX2
# Enter the temperature to predict the ratio :24
# X : [[[25.395]]
...
#  [[19.175]]]
# Enter the value of area used for farming :80000
# Predicted Output is :
# [[8.43234]]
# The Possible production of Rice is : 674587.1734619141

# (base) E:\Mini Project Work>
